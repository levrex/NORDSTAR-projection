...
def cramers_v(x, y):
    """
    Cramers V is used to calculate the correlation between two multi-levelcategorical features!
...
def visualize_umap_bokeh_na_2(embedding, df, l_cat, l_binary=[], patient_id='patnr', cluster_id='PhenoGraph_clusters', title='', path=None):
    ...
    if path == None:
        bio.output_file("/exports/reum/tdmaarseveen/RA_Clustering/TSNE/Baseline_%s.html" % (title), mode='inline')
    else :
